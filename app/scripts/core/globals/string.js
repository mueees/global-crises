...
(function () {
    ...
    //
    // This code was modified by Sean Scott to allow it to be used privately within this closure function. Some code was removed to simplify the design
    ...
    goog.string.escapeChar = function (c) {
        ...
        if (c in goog.string.specialEscapeChars_) {
            goog.string.jsEscapeCache_[c] = goog.string.specialEscapeChars_[c];
            return goog.string.jsEscapeCache_[c];
        }
        ...
        goog.string.jsEscapeCache_[c] = rv;
...
//            we want a dependency on goog.array in goog.string?
    ...
    goog.string.format = function (formatString, var_args) {
        ...
        function replacerDemuxer(match,
            ...
            return goog.string.format.demuxes_[type].apply(null, passArgs);
    ...
    goog.string.format.demuxes_.s = function (value,
        ...
        // and isNaN('') == false.
        if (isNaN(width) || (seed.util.isString(width) && width === '') || replacement.length >= width) {
            return replacement;
        }
    ...
    // Expose the google code through our seed.string object design
    // TODO should we only expose some of the methods and hide things like the demuxes???
    seed.string = goog.string;
